package com.eriagacha.howitsdone.world.biomes;


import com.eriagacha.howitsdone.customtree.RichSaplingBlock;
...
public class CrimsonBiome {
  ...
  public static final Identifier crimsonambient_ID = RegisterItems.id("crimsonambient");
  ...
  public static final RegistryKey<Biome> Crimson_KEY =
      RegistryKey.of(Registry.BIOME_KEY, RegisterItems.id("crimson"));
