...
@Log4j2
public class GachaFurnaceEntity extends BlockEntity implements ExtendedScreenHandlerFactory,
  ...
  public ScreenHandler createMenu(int syncId, PlayerInventory inv, PlayerEntity player) {
    return new GachaFurnaceGui(syncId, inv, ScreenHandlerContext.create(this.world,this.pos));
  }
}